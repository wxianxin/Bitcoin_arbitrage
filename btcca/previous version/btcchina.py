...
############################
    def get_market_depth2(self, market,limit=10, post_data={}):
        post_data['method']='getMarketDepth2'
        post_data['params']=[limit, market]
        return self._private_request(post_data)
 ###########################
    def get_bcmarket_depth2(self,limit=10, market="btccny", post_data={}):
        post_data['method']='getMarketDepth2'
        post_data['params']=[limit, market]
        return self._private_request(post_data)
################
    def get_lbmarket_depth2(self,limit=10, market="ltcbtc", post_data={}):
        post_data['method']='getMarketDepth2'
        post_data['params']=[limit, market]
        return self._private_request(post_data)

    def get_lcmarket_depth2(self,limit=10, market="ltccny", post_data={}):
        post_data['method']='getMarketDepth2'
        post_data['params']=[limit, market]
        return self._private_request(post_data)
...
################
##
    def bcbuy(self, price, amount, market="btccny", post_data={}):
...
###
    def lcbuy(self, price, amount, market="ltccny", post_data={}):
        amountStr = "{0:.4f}".format(round(amount,4))
        post_data['method']='buyOrder2'
        if price == None:
            priceStr = None
...
###
    def lbbuy(self, price, amount, market="ltcbtc", post_data={}):
        amountStr = "{0:.8f}".format(round(amount,8))
        post_data['method']='buyOrder2'
        if price == None:
            priceStr = None
        else:
            priceStr = "{0:.8f}".format(round(price,8))
        post_data['params']=[priceStr, amountStr, market]
        return self._private_request(post_data)
##
    def bcsell(self, price, amount, market="btccny", post_data={}):
        amountStr = "{0:.4f}".format(round(amount,4))
        ...
        return self._private_request(post_data)
###
    def lcsell(self, price, amount, market="ltccny", post_data={}):
        amountStr = "{0:.4f}".format(round(amount,4))
        post_data['method']='sellOrder2'
        if price == None:
            priceStr = None
...
###
    def lbsell(self, price, amount, market="ltcbtc", post_data={}):
        amountStr = "{0:.8f}".format(round(amount,8))
        post_data['method']='sellOrder2'
        if price == None:
            priceStr = None
